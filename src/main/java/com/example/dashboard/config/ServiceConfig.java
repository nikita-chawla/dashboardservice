...
public class ServiceConfig {
    ...
    @Value("${application.services.service1.countmessage}")
    private String service1ServiceCountMessage;

    @Value("${application.services.service2.countmessage}")
    private String service2ServiceCountMessage;

    @Value("${application.services.service3.countmessage}")
    private String service3ServiceCountMessage;

    public String getService1ServiceCountMessage() {
        return service1ServiceCountMessage;
    }

    public void setService1ServiceCountMessage(String service1ServiceCountMessage) {
        this.service1ServiceCountMessage = service1ServiceCountMessage;
    }

    public String getService2ServiceCountMessage() {
        return service2ServiceCountMessage;
    }

    public void setService2ServiceCountMessage(String service2ServiceCountMessage) {
        this.service2ServiceCountMessage = service2ServiceCountMessage;
    }

    public String getService3ServiceCountMessage() {
        return service3ServiceCountMessage;
    }

    public void setService3ServiceCountMessage(String service3ServiceCountMessage) {
        this.service3ServiceCountMessage = service3ServiceCountMessage;
    }
